  ...
  return (
    ...
    >
      <ul className="space-y-2 text-center font-poppins">
        ...
        <li>
          <a href="#about" className="text-[15px] font-medium">
            About
          </a>
        </li>
        <li>
          <a href="#portfolio" className="text-[15px] font-medium">
            Portfolio
          </a>
        </li>
        <li>
          <a href="#clients" className="text-[15px] font-medium">
            Clients
          </a>
        </li>
        <li>
          <a href="#blog" className="text-[15px] font-medium">
            Blog
          </a>
        </li>
        <li>
          <a href="#contact" className="text-[15px] font-medium">
            Contact
          </a>
        </li>
        <li>
