...
const Footer = () => {
  return (
    <footer
      className="relative bg-cover bg-center w-full max-w-7xl mx-auto py-16 px-4 sm:px-8 lg:px-20 text-white font-sans"
      style={{
        backgroundImage: `url(${assets.images.table})`,
      }}    >
      <div className="absolute inset-0 bg-black opacity-70"></div>

      <div className="relative mx-auto py-12 lg:py-16">
      ...
      <div className="relative z-10 mt-12 flex flex-col items-center text-center">
        <div className="flex justify-center items-center text-center space-x-4 text-white mb-6">
          ...
          <a
            ...
            className="w-12 h-12 flex justify-center items-center border-2 border-white rounded-full bg-white text-black"
          >
            <img src={assets.images.instagram} alt="Instagram" className="w-6 h-6" />
          </a>
        </div>
        <p className="text-sm text-gray-400">
          &copy; 2024 <span className="text-yellow-400">Niomax</span> All Rights
          Reserved
        </p>
      </div>
    </footer>
